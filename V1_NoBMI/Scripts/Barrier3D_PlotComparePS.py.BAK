...
for x in range(3):
    ...
    if x == 1:
        loc = (
            "C:\Barrier3D\Output\BatchSims_Group"
            + str(Group[x])
            + "\BatchData_Combined_Group"
            + str(Group[x])
            + "\Data_BatchSims_Combined_Group"
            + str(Group[x])
            + ".xlsx"
        )
    else:
        loc = (
            "E:\Reeves\Backups\Barrier3D_Data\Runs_122-156\BatchData_Combined_Group"
            + str(Group[x])
            + "\Data_BatchSims_Combined_Group"
            + str(Group[x])
            + ".xlsx"
...
plt.show()
if Save:
    PSFig.savefig(saveloc + "PhaseSpace_Result", bbox_inches="tight")
...
ax = PSFig.add_subplot(1, 3, 1)
Cax = ax.matshow(
    Tresult[0], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
...
ax = PSFig.add_subplot(1, 3, 2)
Cax = ax.matshow(
    Tresult[1], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
...
ax = PSFig.add_subplot(1, 3, 3)
Cax = ax.matshow(
    Tresult[2], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
...
plt.show()
if Save:
    PSFig.savefig(saveloc + "PhaseSpace_TimeToDrown", bbox_inches="tight")
...
ax = PSFig.add_subplot(1, 3, 1)
Cax = ax.matshow(
    Width[0], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
...
ax = PSFig.add_subplot(1, 3, 2)
Cax = ax.matshow(
    Width[1], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
none = np.argwhere(np.isnan(Tresult))
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
...
ax = PSFig.add_subplot(1, 3, 3)
Cax = ax.matshow(
    Width[2], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
none = np.argwhere(np.isnan(Tresult))
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
...
plt.show()
if Save:
    PSFig.savefig(saveloc + "PhaseSpace_Width", bbox_inches="tight")
...
ax = PSFig.add_subplot(1, 3, 1)
Cax = ax.matshow(
    SC[0], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
none = np.argwhere(np.isnan(Tresult))
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
...
ax = PSFig.add_subplot(1, 3, 2)
Cax = ax.matshow(
    SC[1], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
none = np.argwhere(np.isnan(Tresult))
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
...
ax = PSFig.add_subplot(1, 3, 3)
Cax = ax.matshow(
    SC[2], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
none = np.argwhere(np.isnan(Tresult))
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
...
plt.show()
if Save:
    PSFig.savefig(saveloc + "PhaseSpace_ShorelineChange", bbox_inches="tight")
...
plt.show()
if Save:
    PSFig.savefig(saveloc + "PhaseSpace_DuneHeight", bbox_inches="tight")
...
ax = PSFig.add_subplot(1, 3, 1)
Cax = ax.matshow(
    IntElev[0], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
none = np.argwhere(np.isnan(Tresult))
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
...
ax = PSFig.add_subplot(1, 3, 2)
Cax = ax.matshow(
    IntElev[1], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
none = np.argwhere(np.isnan(Tresult))
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
...
ax = PSFig.add_subplot(1, 3, 3)
Cax = ax.matshow(
    IntElev[2], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
none = np.argwhere(np.isnan(Tresult))
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
...
plt.show()
if Save:
    PSFig.savefig(saveloc + "PhaseSpace_Elevation", bbox_inches="tight")
...
ax = PSFig.add_subplot(1, 3, 1)
Cax = ax.matshow(
    Punctuated[0], origin="lower", cmap="Greys", aspect="auto", vmin=0, vmax=1
)
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
ax.set_yticklabels(ytic)
...
ax = PSFig.add_subplot(1, 3, 2)
Cax = ax.matshow(
    Punctuated[1], origin="lower", cmap="Greys", aspect="auto", vmin=0, vmax=1
)
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
ax.set_yticklabels(ytic)
...
ax = PSFig.add_subplot(1, 3, 3)
Cax = ax.matshow(
    Punctuated[2], origin="lower", cmap="Greys", aspect="auto", vmin=0, vmax=1
)
ax.xaxis.set_ticks_position("bottom")
ax.set_xticklabels(xtic)
ax.set_yticklabels(ytic)
...
ax = PSFig.add_subplot(1, 3, 1)
Cax = ax.matshow(
    SCperiod[0], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
...
ax = PSFig.add_subplot(1, 3, 2)
Cax = ax.matshow(
    SCperiod[1], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
...
ax = PSFig.add_subplot(1, 3, 3)
Cax = ax.matshow(
    SCperiod[2], origin="lower", cmap="Greys", aspect="auto", vmin=VMin, vmax=VMax
)
...
plt.show()
if Save:
    PSFig.savefig(saveloc + "PhaseSpace_Timescale", bbox_inches="tight")
...
ax = PSFig.add_subplot(1, 3, 1)
Cax = ax.matshow(
    Pspace1[0], origin="lower", cmap=cm2, aspect="auto", vmin=VMin, vmax=VMax
)
...
ax = PSFig.add_subplot(1, 3, 2)
Cax = ax.matshow(
    Pspace1[1], origin="lower", cmap=cm2, aspect="auto", vmin=VMin, vmax=VMax
)
...
ax = PSFig.add_subplot(1, 3, 3)
Cax = ax.matshow(
    Pspace1[2], origin="lower", cmap=cm2, aspect="auto", vmin=VMin, vmax=VMax
)
...
ax = PSFig.add_subplot(1, 3, 1)
Cax = ax.matshow(
    Pspace2[0], origin="lower", cmap=cm2, aspect="auto", vmin=VMin, vmax=VMax
)
none = np.argwhere(np.isnan(Pspace1[0]))
for j in none:
    y, x = j
...
ax = PSFig.add_subplot(1, 3, 2)
Cax = ax.matshow(
    Pspace2[1], origin="lower", cmap=cm2, aspect="auto", vmin=VMin, vmax=VMax
)
...
ax = PSFig.add_subplot(1, 3, 3)
Cax = ax.matshow(
    Pspace2[2], origin="lower", cmap=cm2, aspect="auto", vmin=VMin, vmax=VMax
)
