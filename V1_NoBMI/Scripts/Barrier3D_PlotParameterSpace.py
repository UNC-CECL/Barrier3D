...
if Save == True:
    PSFig.savefig(saveloc + "PhaseSpace_Result")
...
if Save == True:
    PSFig.savefig(saveloc + "PhaseSpace_TimeToDrown")

# Width
PSFig = plt.figure(figsize=(14, 8))
ax = PSFig.add_subplot(111)
cax = ax.matshow(
    Width, origin="lower", cmap="Greys", aspect="auto"
)  # , vmin=0, vmax=450)
ax.xaxis.set_ticks_position("bottom")
cbar = PSFig.colorbar(cax)
...
if Save == True:
    PSFig.savefig(saveloc + "PhaseSpace_Width")

# SC
PSFig = plt.figure(figsize=(14, 8))
ax = PSFig.add_subplot(111)
cax = ax.matshow(
    SC, origin="lower", cmap="Greys", aspect="auto"
)  # , vmin=0.25, vmax=1)
ax.xaxis.set_ticks_position("bottom")
cbar = PSFig.colorbar(cax)
...
if Save == True:
    PSFig.savefig(saveloc + "PhaseSpace_ShorelineChange")

# Hd
PSFig = plt.figure(figsize=(14, 8))
ax = PSFig.add_subplot(111)
cax = ax.matshow(
    Hd, origin="lower", cmap="Greys", aspect="auto"
)  # , vmin=0.1, vmax=1.5)
ax.xaxis.set_ticks_position("bottom")
cbar = PSFig.colorbar(cax)
cbar.set_label("Meters", rotation=270, labelpad=20)
...
if Save == True:
    PSFig.savefig(saveloc + "PhaseSpace_DuneHeight")

# IntElev
PSFig = plt.figure(figsize=(14, 8))
ax = PSFig.add_subplot(111)
cax = ax.matshow(
    IntElev, origin="lower", cmap="Greys", aspect="auto"
)  # , vmin=0.1, vmax=1.7)
ax.xaxis.set_ticks_position("bottom")
cbar = PSFig.colorbar(cax)
cbar.set_label("Meters", rotation=270, labelpad=20)
...
if Save == True:
    PSFig.savefig(saveloc + "PhaseSpace_Elevation")

# Punctuated
PSFig = plt.figure(figsize=(14, 8))
ax = PSFig.add_subplot(111)
cax = ax.matshow(
    Punctuated2, origin="lower", cmap="Greys", aspect="auto", vmin=0, vmax=1
)
ax.xaxis.set_ticks_position("bottom")
cbar = PSFig.colorbar(cax)
cbar.set_label("Probability", rotation=270, labelpad=20)
...
if Save == True:
    PSFig.savefig(saveloc + "PhaseSpace_Punctuated")

# Characteristic Timescale
PSFig = plt.figure(figsize=(14, 8))
ax = PSFig.add_subplot(111)
cax = ax.matshow(
    SCperiod, origin="lower", cmap="Greys", aspect="auto"
)  # , vmin=80, vmax=420)
...
if Save == True:
    PSFig.savefig(saveloc + "PhaseSpace_Timescale")
...
ax = PSFig.add_subplot(111)
cax = ax.matshow(
    Pspace1, origin="lower", cmap="Greys", aspect="auto"
)  # , vmin=10, vmax=90)
...
if Save == True:
    PSFig.savefig(saveloc + "PhaseSpace_SlowDur")

# FastDur
PSFig = plt.figure(figsize=(14, 8))
ax = PSFig.add_subplot(111)
cax = ax.matshow(
    Pspace2, origin="lower", cmap="Greys", aspect="auto"
)  # , vmin=20, vmax=400)
...
if Save == True:
    PSFig.savefig(saveloc + "PhaseSpace_FastDur")
