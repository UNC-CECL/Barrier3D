    ...
    def update(self):
        ...
        if abs(self._SCRagg) >= 1:
            ...
            if (
                ...
                for d in range(sc):
                    # New interior row added with elev. of previous dune field (i.e. previous dune row now part of int.)
                    ...
                    if self._DuneParamStart == 0:  # Note, used to be StormTimeSeries
